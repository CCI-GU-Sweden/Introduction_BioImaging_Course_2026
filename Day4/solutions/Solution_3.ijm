...
// overlay the results of the segmentation on the original image using green
// color for the drawing.
// hint look at the roi manager functionality
// look at the draw functionality
// carefull with the image type
// do not overwrite your images
// save the image in an desired output folder
