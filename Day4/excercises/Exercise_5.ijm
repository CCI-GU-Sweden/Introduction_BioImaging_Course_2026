...
// Now we trace back, we want to calculate the circularity of the segmented cell,
// do that for a single image. However use the ROI manager functionality for this.
// hit: Clear Results
//		roiManager - count, select, measure
